...
//NTnet
#define COMSIG_COMPONENT_EXONET_RECEIVE "exonet_receive"			//called on an object by its EXONET connection component on receive. (sending_id(number), sending_netname(text), data(datum/netdata))
