...
/obj/mecha/proc/mech_toxin_damage(mob/living/target)
	...
	if(targetreagents)
		if(targetreagents.get_reagent_amount("cryptobiolin") + force < force*2)
			targetreagents.add_reagent("cryptobiolin", force/2)
		if(targetreagents.get_reagent_amount("toxin") + force < force*2)
			targetreagents.add_reagent("toxin", force/2.5)
