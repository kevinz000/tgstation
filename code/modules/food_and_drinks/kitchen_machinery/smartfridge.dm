...
/obj/machinery/smartfridge/drinks/accept_check(obj/item/O)
	if(!istype(O, /obj/item/reagent_containers) || !Oreagents || !Oreagents.reagent_list.len)
		return FALSE
...
/obj/machinery/smartfridge/chemistry/accept_check(obj/item/O)
	...
	if(istype(O, /obj/item/reagent_containers/pill)) // empty pill prank ok
		return TRUE
	if(!Oreagents || !Oreagents.reagent_list.len) // other empty containers not accepted
		return FALSE
