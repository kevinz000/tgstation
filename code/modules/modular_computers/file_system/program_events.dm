...
/datum/computer_file/program/proc/event_networkfailure(background)
	...
	if(background)
		...
		computer.visible_message("<span class='danger'>\The [computer]'s screen briefly freezes and then shows \"NETWORK ERROR - exonet connection lost. Please retry. If problem persists contact your system administrator.\" error.</span>")
