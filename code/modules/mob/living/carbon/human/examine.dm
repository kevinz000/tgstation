...
//this is very slightly better than it was because you can use it more places. still can't do \his[src] though.
	...
	if(w_uniform && !(slot_w_uniform in obscured))
		...
		if(length(w_uniform.return_blood_DNA()))
	...
	//head
	if(head)
		if(length(head.return_blood_DNA()))
	...
	//suit/armor
	if(wear_suit)
		if(length(wear_suit.return_blood_DNA()))
		...
		//suit/armor storage
		if(s_store)
			if(length(s_store.return_blood_DNA()))
	...
	//back
	if(back)
		if(length(back.return_blood_DNA()))
	...
	if(gloves && !(slot_gloves in obscured))
		if(length(gloves.return_blood_DNA()))
	...
	else if(length(return_blood_DNA()))
	...
	//belt
	if(belt)
		if(length(belt.return_blood_DNA()))
	...
	if(shoes && !(slot_shoes in obscured))
		if(length(shoes.return_blood_DNA()))
	...
	if(wear_mask && !(slot_wear_mask in obscured))
		if(length(wear_mask.return_blood_DNA()))
	...
	if(glasses && !(slot_glasses in obscured))
		if(length(glasses.return_blood_DNA()))
